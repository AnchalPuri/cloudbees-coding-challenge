...
type BlogServiceClient interface {
	...
	DeletePost(ctx context.Context, in *PostID, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *blogServiceClient) DeletePost(ctx context.Context, in *PostID, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
type BlogServiceServer interface {
	...
	DeletePost(context.Context, *PostID) (*Response, error)
...
func (UnimplementedBlogServiceServer) DeletePost(context.Context, *PostID) (*Response, error) {
